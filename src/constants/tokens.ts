...
export const WETH9: TokenMap = {
  ...
  [ChainId.FINDORA_TESTNET]: new Token(ChainId.FINDORA_TESTNET, WETH9_ADDRESS[ChainId.FINDORA_TESTNET], 18, 'WETH', 'Wrapped Ether on Findora'),
}
...
export const WNATIVE: TokenMap = {
  ...
  [ChainId.FINDORA_TESTNET]: new Token(ChainId.FINDORA_TESTNET, WNATIVE_ADDRESS[ChainId.FINDORA_TESTNET], 18, 'WFRA', 'Wrapped Ether on Findora'),
}
